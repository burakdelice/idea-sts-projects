package org.example.ornek06.app;

import org.example.ornek06.repository.OgrenciRepository;
...
public class AppMainOzellestirilmisIstisna {
    ...
    private static void ogrenciListesiGoster() {
        ogrenciRepository.getOgrenciListesi().forEach(ogr-> System.out.println(ogr.getId()+" "+ ));
    }
